import { MyTaskCardProps, UserInfo, UserTaskInfo } from '@/lib/types'
...
export const MyTaskCard: React.FC<MyTaskCardProps> = ({ groupId, task, getAllData, successToast }) => {
    ...
    <div className='m-2 py-2 px-4 min-w-40 border rounded bg-neutral-300 space-y-2 w-full'>
      <div className='flex flex-row space-x-3'>
        ...
        <div className='flex flex-col-reverse items-end'>
          ...
          <div className='flex'>
            <Link className='p-1 bg-black text-white rounded' href={`/mygroups/${groupId}/${task.id}`}>
